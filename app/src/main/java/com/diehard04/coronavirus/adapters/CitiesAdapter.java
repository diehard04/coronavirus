...
import com.diehard04.coronavirus.model.CitiesModel;
...
public class CitiesAdapter extends RecyclerView.Adapter<CitiesAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CitiesAdapter.MyViewHolder holder, int position) {
        ...
        holder.adCitiesTvTotalDeath.setText(citiesModelArrayList.get(position).getTotalDeath());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        public TextView adCitiesTvCityName, adCitiesTvTotalCases, adCitiesTvTotalNewCases, adCitiesTvTotalDeath, adCitiesTvtvTotalRecoveredCases;
        public MyViewHolder(@NonNull View itemView) {
            ...
            adCitiesTvTotalDeath = itemView.findViewById(R.id.ad_cities_tv_total_death);
